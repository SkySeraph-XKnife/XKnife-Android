...
import com.skyseraph.xknife.lib.widge.module.loading.indicators.Indicator;
import com.skyseraph.xknife.lib.widge.module.loading.indicators.SemiCircleSpinIndicator;


/**
 * from: https://github.com/81813780/AVLoadingIndicatorView
 */
...
public class IndicatorLoadingView extends View {
    ...
    private static final SemiCircleSpinIndicator DEFAULT_INDICATOR = new SemiCircleSpinIndicator();
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        String indicatorName = a.getString(R.styleable.IndicatorLoadingView_indicatorName);
