...
import com.skyseraph.xknife.lib.utils.file.FileUtils;
...
public class IntentUtils {
     ...
     *
     * @param filePath 文件路径
     * @return intent install app intent
     */
     ...
     * @return intent uninstall app intent
     */
     ...
     * @param context     上下文
     * @param packageName 包名
     * @return intent launch app intent
     */
     ...
     *
     * @param packageName 包名
     * @return intent app details settings intent
     */
     ...
     *
     * @param content 分享文本
     * @return intent share text intent
     */
     ...
     * @param packageName 包名
     * @param className   全类名
     * @return intent component intent
     */
