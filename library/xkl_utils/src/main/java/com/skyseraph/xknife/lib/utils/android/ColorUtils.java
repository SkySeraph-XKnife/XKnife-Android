...
public class ColorUtils {
    ...
    /**
     * Gets new color by start end.
     *
     * @param context    the context
     * @param fraction   the fraction
     * @param startValue the start value
     * @param endValue   the end value
     * @return the new color by start end
     */
    public static int getNewColorByStartEnd(Context context, float fraction, int startValue, int endValue) {
